        ...
        <table>
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>";
                    echo "<td width='250px'><img  src='image/" . $row["service_image"] . "'></td>";
                    echo "<td>" . $row["service_name"] . "</td>";
                    echo "<td>" . $row["info"] . "</td>";
                    echo "<td> &#8377 " . $row["price"] . "</td>";
                    echo "<td> <a href='delete_service.php?id=" . $row["id"] . "' onclick='return confirm(\"Are you sure you want to delete this car?\")'>Delete</a></td>";
                    echo "</tr>";
                }
            } else {
