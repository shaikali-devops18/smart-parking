...
$sql = "SELECT s.id, s.serviceid, s.username, s.booking_date, sr.price, sr.service_name 
FROM srequests s
JOIN services sr ON s.serviceid = sr.id ";
        ...
        <table>
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td> <a href='delete_ser.php?id=" . $row["id"] . "' >Done</a></td>";
                    echo "</tr>";
                }
            } else {
